<div class="w-full">
    ...
    <div class="grid grid-cols-7 border-t-2 border-white text-xl">
        <div class="font-bold uppercase p-2 text-center truncate">Sunday</div>
        <div class="font-bold uppercase p-2 text-center truncate">Monday</div>
        <div class="font-bold uppercase p-2 text-center truncate">Tuesday</div>
        <div class="font-bold uppercase p-2 text-center truncate">Wednesday</div>
        <div class="font-bold uppercase p-2 text-center truncate">Thursday</div>
        <div class="font-bold uppercase p-2 text-center truncate">Friday</div>
        <div class="font-bold uppercase p-2 text-center truncate">Saturday</div>
    </div>

    <div class="grid grid-cols-7 h-[calc(100vh-125px)]">
        @foreach($calendatDateMatrix as $dates)
        @if(!is_null($dates) && $dates['full_date'] === $dateNow)
            <div class="bg-green-100 border-1 p-2 border-gray-100">
