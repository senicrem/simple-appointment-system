    ...
    <div class="font-mono bg-slate-300 p-4 w-[55rem]">
        ...
        <div class="max-h-[500px] overflow-y-auto">
            @foreach($appointments as $appointment)
                ...
                <div class="group">
                    <div class="text-sm p-2 border-b-1 border-slate-800 group-hover:bg-slate-200 transition-all delay-200">
                        ...
                        <div class="flex justify-between">
                            <p>{{$p['concern']}}</p>
                            <div class="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity delay-200">
