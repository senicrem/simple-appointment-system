  ...
  <div class="bg-white p-6 rounded-lg w-96">
    ...
    <form>
      ...
      <div class="mb-4">
        ...
        <textarea name="concern" id="concern" class="mt-1 p-2 w-full border border-gray-300 rounded-lg" placeholder="Enter your concern...">
      ...
      <div class="flex justify-end space-x-4">
        <button wire:click="modalSwitch(false)" type="button" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg" id="close-modal">
            Cancel
        </button>
